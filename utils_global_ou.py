# ============================================================================
# GLOBAL UTILS - OU Filtering for ALL Dashboards (No Page Updates Needed)
# ============================================================================
...
# ============================================================================
# ENHANCED setup_account_filter() - WORKS AUTOMATICALLY ON ALL PAGES
# ============================================================================
...
def setup_account_filter(page_key="default", org2_ou_id=None):
    ...
    Args:
        page_key (str): Unique key for this filter instance (e.g., 'patch', 'ecs')
                       No need to pass org2_ou_id - uses global ORG2_OU_ID
