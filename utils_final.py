# ============================================================================
# UTILS.PY - Global OU Filtering (FIXED: Regions, Account Names, OU Issues)
# ============================================================================
...
def setup_account_filter(page_key="default", org2_ou_id=None):
    ...
    # =====================================================================
    # DEBUG: Show account structure
    # =====================================================================
    # Uncomment to debug account structure from main.py
    # st.sidebar.write("DEBUG - Account structure:")
    # if all_accounts:
    #     st.sidebar.write(f"First account: {all_accounts[0]}")
    #     st.sidebar.write(f"Account keys: {all_accounts[0].keys() if hasattr(all_accounts[0], 'keys') else 'dict-like'}")
    ...
    if active_ou_id:
        ...
        # st.sidebar.write(f"DEBUG - Org2 accounts in OU: {org2_accounts}")
    ...
    # FIX: Handle account names properly
    # Account structure from main.py can be dict or object with 'name' or 'Name' key
    account_names = []
    account_ids_list = []
